...
export const CustomDialog: FC<CustomDialogProps> = ({ isOpen, children }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
      <div className="flex h-fit min-w-[30vw] gap-0 rounded-xl bg-white p-0 text-xs m-4 md:m-0">
        {children}
      </div>
    </div>
  );
...
export const TermsDialog: FC<TermsDialogProps> = ({ isOpen: propIsOpen, onClose: propOnClose }) => {
  ...
  return (
    <CustomDialog isOpen={isOpen}>
      {/* <div className="m-0 flex h-fit w-fit md:max-w-[700px] gap-0 rounded-xl bg-white p-0 text-xs"> */}
      <div className="m-0 flex h-fit w-[600px] gap-0 rounded-xl bg-white p-0 text-xs">
        ...
        <div className="flex h-full basis-full flex-col justify-between p-6 font-['Gilroy'] md:basis-[60%]">
          <div>
            <div className="flex flex-row-reverse justify-between md:flex-col">
              ...
              <Image
                ...
                className="h-16 w-32 md:h-20 md:w-44 mb-4"
                width={2560}
                height={1024}
              />
            </div>
            <div className="font-medium text-sm md:text-base">
              ...
              <p className="mb-4 leading-5 md:leading-relaxed">
          ...
          <div>
            <>
              ...
              <div className="items-top mb-4 flex space-x-2">
                ...
                <div className="grid gap-1.5 leading-none">
                  <label
                    htmlFor="terms1"
                    className="font-medium text-xs md:text-sm leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70"
                  >
            ...
            <Button
              ...
              onClick={handleEnterRenewMe}
            >
              Enter RenewMe
            </Button>
            <div className="flex w-full items-center justify-center">
              <p className="mb-4 w-[80%] text-center text-xs md:text-sm leading-4 text-zinc-400">
