    ...
    <React.Fragment>
      <Container className="w-full mb-[41px]">
        <div className="outline outline-2 outline-[#B38DB2] flex flex-col items-center p-[30px] rounded-2xl">
          ...
          <h1 className="text-[#303030] font-semibold text-[22px] font-Urbanist leading-[26.4px]">
            Daily Pep Talks
          </h1>
          <p className="text-sm font-medium text-center max-w-[154px] mb-4 font-Urbanist mt-1 text-[#707070] leading-[16.8px]">
          Begin your journey with a dose of positivity.
          </p>
          <EmblaCarousel />
        </div>
      </Container>
