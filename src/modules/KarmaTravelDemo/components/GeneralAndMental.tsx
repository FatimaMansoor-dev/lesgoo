  ...
  return (
    <>
      <Container className="mb-[39.5px] mt-[15px] flex h-[164px] w-full gap-[15px] text-white">
        <div
          className="group relative h-[156px] w-[117px]  cursor-pointer text-[20px] font-['Urbanist'] rounded-[10px] bg-[#A251AB] p-4 transition-all duration-150 ease-in-out hover:bg-[#8e3f94]"
        ...
        <div
          className="group relative h-[156px] w-[204px] text-[20px] font-['Urbanist'] cursor-pointer rounded-[10px] bg-[#132979] p-4 transition-all duration-150 ease-in-out hover:bg-[#0f2162]"
