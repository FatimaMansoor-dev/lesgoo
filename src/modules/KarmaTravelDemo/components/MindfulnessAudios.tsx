    ...
    <Container className="w-full mb-[26.5px]" id="mindfulness-audios">
      ...
      <div className="relative">
        ...
        >
                  ...
                  className={cn(
                    'w-full h-[76px] max-w-[185px] bg-transparent flex gap-2 rounded-2xl p-4 items-center cursor-pointer hover:bg-zinc-100/80 duration-150 transition-all ease-in-out',
                    {
                      'border-2 border-[#132979] transition-colors duration-300':
                        activeAudio === index,
                      'transition-colors duration-300 bg-zinc-100/80': activeAudio !== index,
                    }
                  )}
          ...
          <CarouselPrevious
            className={cn(
              'absolute left-2 top-1/2 z-10 bg-[#132979] hover:bg-[#0f2162] border-transparent text-white hover:text-white flex items-center justify-center',
              currentIndex === 0 && 'hidden'
            )}
          />
          <CarouselNext
            className={cn(
              'absolute right-2 top-1/2 z-10 bg-[#132979] hover:bg-[#0f2162] border-transparent text-white hover:text-white flex items-center justify-center',
      ...
      <div className="w-full border-2 border-[#132979] rounded-2xl mt-2.5 h-[76px] p-4 flex items-center justify-between">
        {activeAudio !== null && isPlaying ? (
          <div
            className="rounded-full bg-[#132979] hover:bg-[#0f2162] duration-150 transition-all ease-in-out cursor-pointer h-[50px] aspect-square flex items-center justify-center"
