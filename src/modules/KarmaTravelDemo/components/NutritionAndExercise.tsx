  ...
  return (
    <>
      <Container className="mt-[15px] flex h-[164px] w-full gap-[15px] text-white">
        <div
          className="group relative h-[156px] w-[208px] cursor-pointer text-[20px] font-['Urbanist'] overflow-hidden rounded-[10px] bg-[#4F65CC] p-[14px] transition-all duration-150 ease-in-out hover:bg-[#3b54b0]"
        ...
        <div
          className="group relative h-[156px] w-[111px] text-[20px] font-['Urbanist'] cursor-pointer overflow-hidden rounded-[10px] bg-[#2C38BC] p-[14px] transition-all duration-150 ease-in-out hover:bg-[#2C38BC]"
