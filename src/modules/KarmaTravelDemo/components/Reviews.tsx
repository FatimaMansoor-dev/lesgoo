...
const Reviews = () => {
  ...
  return (
    <div className="max-w-[375px] mb-[22px] w-full">
      <div className="border-b-[#E7E7E7] border-b px-[18px] pb-[14px]">
        <h2 className="text-[#303030] text-[22px] font-semibold leading-[26px] font-['Urbanist]">
      ...
      >
        ...
        <div className="mt-[18px] flex justify-center">
          <div className="relative mx-auto flex items-center justify-between pb-[32px]">
              ...
              {visibleDots.map(index => (
                <div
                  ...
                  className={cn(
                    ...
                    currentIndex === index ? 'bg-[#4F65CC] w-[35px]' : 'bg-zinc-200 w-[13px]'
                  )}
                ></div>
              ))}
              {end < totalDots && (
      ...
      <div className="border-b-[#E7E7E7] border-b pb-[36px]">
        <button
          data-senja-collector-open="myrenewme"
          data-url="https://senja.io/p/myrenewme/r/HN1DJF"
          className="bg-[#A251AB] hover:bg-[#8e3f94] text-white max-w-[299px] justify-center font-semibold mx-auto w-full rounded-[12px] h-[41px] flex items-center gap-[7px] text-sm"
        >
          Leave us a review{' '}
          <Image
