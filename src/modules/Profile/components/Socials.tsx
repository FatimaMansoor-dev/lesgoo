...
type SocialType = 'instagram' | 'twitter' | 'linkedin' | 'imdb' | 'linktree';
...
const contactTypes: { type: SocialType; label: string }[] = [
  { type: 'instagram', label: 'Instagram' },
  { type: 'twitter', label: 'Twitter' },
  { type: 'linkedin', label: 'LinkedIn' },
  { type: 'imdb', label: 'IMDB' },
  { type: 'linktree', label: 'Linktree' },
];

const Socials = () => {
  const [addNewModal, setAddNewModal] = useState(false);
  const [items, setItems] = useState<Item[]>([
    { id: 1, type: 'instagram', value: 'https://www.instagram.com/drlisapalmer' },
    { id: 2, type: 'twitter', value: 'https://x.com/drlisacpalmer?s=21' },
    {
      id: 3,
      type: 'linktree',
      value:
        'https://linktr.ee/Renewyourlife?utm_source=link_profile_share&ltsid=ffdf2b6a-9dde-4368-af8a-4d389ece5d24',
    },
    { id: 4, type: 'linkedin', value: 'https://www.linkedin.com/in/drlisapalmer' },
  ]);
  ...
  const addNewItem = (type: SocialType) => {
  ...
  const saveItems = () => {
    ...
    // console.log('socialLinks', updatedItems);
  };
  ...
  return (
    <div className="relative flex w-screen flex-col items-center transition-all duration-150 ease-in-out font-['Urbanist']">
      <div className="mb-9 w-full max-w-[375px] pt-[14px]">
        <h2 className="mb-[17px] text-[22px] font-semibold text-center leading-[26px]">Socials</h2>
        <div className="bg-[#FBFBFB] p-[27px_25px]">
                ...
                <div key={item.id} className="flex items-center gap-[9px]">
                  ...
                  <div className="bg-white border-[#00000033] border p-[13px_16px_13px_15px] flex justify-between items-center rounded-[10px] w-full">
                    <div className="flex gap-[9px] items-center">
                      <div className="bg-[#D9D9D94D] min-w-[34px] h-[34px] rounded-full flex justify-center items-center">
                        <Image
          ...
          <button
            onClick={saveItems}
            className="bg-[#A850B2] hover:bg-[#8e3f94] mt-[27px] rounded-[22px] h-[45px] text-[14px] font-semibold text-center leading-[17px] w-full text-white"
          >
            Save
          </button>
        </div>
        ...
        <div className="fixed inset-0 flex justify-center items-center z-10 ">
          ...
          <div className="relative shadow-lg w-[287px] rounded-[14px]">
            <div className="bg-white w-full rounded-[11px] p-[23px_18.5px_21.5px_17px]">
              <h2 className="text-[#00000080] text-[22px] text-center mb-[14px]">
                Select an option
              </h2>
              <div>
