...
import LisaPhoto from '../../../../public/assets/YourBrandSample/Ads/LisaPhoto.png';
      ...
      <div className="relative shadow-lg w-[306px] bg-white rounded-[14px]">
        ...
        <div className="flex flex-col justify-center items-center mt-[30px]">
          <p className="text-[#191919] text-[14px] font-['Urbanist'] leading-[19px] text-center w-full max-w-[255px]">
            Discover the nation&apos;s premiere boutique “reality-based” customized wellness
            programs designed to help you achieve rapid results to regain and maintain life balance
            from eating disorders, trauma, addictions, and relationships.
          </p>
          <div>
            <button
              className={`${buttonClass} w-[256px] h-[46px] flex justify-center items-center rounded-full mt-[14px] mb-[27px] text-[#FFFFFF] text-[14px] font-semibold font-['Urbanist']`}
            >
              <Link
                onClick={e => {
                  e.preventDefault();
