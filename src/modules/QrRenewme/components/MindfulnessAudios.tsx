  ...
  return (
    <Container className="w-full mb-[26.5px]" id="mindfulness-audios">
      <div className="mb-4 flex justify-between items-center">
        <div>
          <h1 className="font-semibold text-[22px] text-[#303030] font-['Urbanist']">
            Mindfulness
          </h1>
        ...
        <button
          ...
          className="text-[#A74FB1] text-[14px] font-medium flex gap-2"
        >
          View more
          <Image
      ...
      <div className="relative">
        ...
        >
              ...
              <CarouselItem key={index} className="basis-[53%]">
                <div
                  className={cn(
                    ...
                    {
                      'border-2 border-[#132979] transition-colors duration-300':
                        activeAudio === index,
          ...
          <CarouselPrevious
            className={cn(
              'absolute left-2 top-1/2 z-10 bg-[#132979] hover:bg-[#132979] border-transparent text-white hover:text-white flex items-center justify-center',
              currentIndex === 0 && 'hidden'
            )}
          />
          <CarouselNext
            className={cn(
              'absolute right-2 top-1/2 z-10 bg-[#132979] hover:bg-[#132979] border-transparent text-white hover:text-white flex items-center justify-center',
      ...
      <div className="w-full border-2 border-[#132979] rounded-2xl mt-2.5 h-[76px] p-4 flex items-center justify-between">
        {activeAudio !== null && isPlaying ? (
          <div
            className="rounded-full bg-[#132979] hover:bg-[#d36c49] duration-150 transition-all ease-in-out cursor-pointer h-[50px] aspect-square flex items-center justify-center"
        ...
        <div id="waveform" ref={waveformRef} className="flex-1 h-12 mx-4 relative">
          {isLoading && (
            <div className="absolute inset-0 flex items-center justify-center">
              <Loader2 size={20} className="text-[#132979] animate-spin" />
            </div>
          )}
        </div>
