...
const Welcome: React.FC = () => {
  return (
    <Container className="w-full items-end flex gap-3 text-white">
      <div className="group relative w-full rounded-2xl bg-[#132979] px-3 py-[25px] cursor-pointer hover:bg-[#132979] h-[146px] flex items-center justify-start">
        <div>
          <h2 className="text-[36px] leading-[43.2px] font-bold text-white font-['Urbanist']">
            Be Balanced
          </h2>
          <p className="max-w-[214px] text-[14px] font-medium leading-[22px] mt-4">
            {/* Join us in making the world better. Enjoy your life and find balance with mindfulness. */}
            Live well, breathe deeply.
          </p>
        </div>
        {/* <Image
