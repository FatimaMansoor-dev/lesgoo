...
const YourBrandSampleModal: React.FC<ModalProps> = ({ listId, onTermsOpen }) => {
      ...
      <div className="relative shadow-lg w-[306px] mt-[-56px] rounded-[14px]">
        ...
        <div className="w-full rounded-b-[14px] relative z-[1] mt-[-120px]">
          <div className="flex flex-col justify-center items-center">
            ...
            />
            <Image
              src={`${imageDomainUrl}/YourBrandSample/Ads/heythere.png`}
              alt="HeyThere"
              width={134}
              height={62}
            />
          ...
          <div className="flex flex-col justify-center items-center">
            <p className="w-full max-w-[255px] text-[14px] leading-[19px] font-['Urbanist'] text-[#191919] text-center">
              Begin your journey to a more balanced life, sign up for our newsletter today!
            </p>
            ...
            <button
              ...
              className="w-[256px] h-[44px] bg-[#01C1C6] rounded-full flex justify-center items-center mt-[16px] mb-[42px] text-white font-semibold text-[14px]"
            >
              Sign Up
            </button>
          </div>
        </div>
        <div className='bg-[linear-gradient(180deg,_rgba(255,255,255,0)_0%,#FFFFFF_49.91%)] h-full absolute top-0 w-full rounded-b-[14px]'></div>
      </div>
...
export default YourBrandSampleModal;
