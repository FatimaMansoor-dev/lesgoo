...
const Welcome: React.FC = () => {
  return (
    <Container className="w-full items-end flex gap-3 text-white">
      <div className="group relative w-full rounded-[10px] bg-[#132979] px-3 py-[27px] cursor-pointer hover:bg-[#3b54b0] h-[146px] flex items-center justify-start ">
        <div>
          <h2 className="text-[34px] leading-[40px] max-w-[180px] font-bold mb-[11px] text-white font-['Urbanist']">
            Soulscape
          </h2>
