    ...
    >
      ...
      <div className="container isolate mx-auto flex flex-col items-center gap-6 px-6 md:gap-10 lg:gap-24">
        ...
        <div className="relative flex w-full rounded-[100px] bg-white md:max-w-[500px] lg:max-w-[730px]">
          <button className="w-full pl-4 bg-white hover:bg-[#ffefc8] transition-all duration-100 ease-in-out py-5 font-['Gilroy'] text-base font-[400] text-black-1 rounded-[100px] md:px-7 md:text-lg lg:text-xl flex items-center justify-center">
            {/* <a
