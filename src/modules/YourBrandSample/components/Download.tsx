  ...
  return (
    <Container className="mt-4 flex h-16 w-full gap-3 text-white">
      <div
        ...
        className="group relative flex h-full w-full text-[20px] font-['Urbanist'] cursor-pointer items-center overflow-hidden rounded-2xl bg-[#9AC17E] p-3 font-semibold leading-tight transition-all duration-300 ease-in-out hover:bg-[#9AC17E]"
      >
        Mindfulness Audios
        <Image
