  ...
  return (
    <>
      <Container className="mb-[39.5px] mt-[15px] flex h-[164px] w-full gap-[15px] text-white">
        <div
          className="group relative h-full w-[60%] cursor-pointer text-[20px] font-['Urbanist'] rounded-2xl bg-[#F07E58] p-4 transition-all duration-150 ease-in-out hover:bg-[#F07E58]"
        ...
        <div
          className="group relative h-full w-full text-[20px] font-['Urbanist'] cursor-pointer rounded-2xl bg-[#BB82BA] p-4 transition-all duration-150 ease-in-out hover:bg-[#BB82BA]"
