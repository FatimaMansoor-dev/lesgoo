  ...
  return (
    <>
      <Container className="mt-[15px] flex h-[164px] w-full gap-[15px] text-white">
        <div
          className="group relative h-full w-full cursor-pointer text-[20px] font-['Urbanist'] overflow-hidden rounded-2xl bg-[#2AB4B8] p-[14px] transition-all duration-150 ease-in-out hover:bg-[#2AB4B8]"
        ...
        <div
          className="group relative h-full w-[60%] text-[20px] font-['Urbanist'] cursor-pointer overflow-hidden rounded-2xl bg-[#9AC17C] p-[14px] transition-all duration-150 ease-in-out hover:bg-[#9AC17C]"
