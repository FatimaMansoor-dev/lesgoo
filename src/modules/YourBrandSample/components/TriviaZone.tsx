...
const TriviaZone: React.FC = () => {
  ...
  // Create a new array of trivia items with the desired sequence
  ...
  useEffect(() => {
    ...
    const onSelect = () => {
      ...
      // setShowRightGradient(selectedIndex < sequencedTriviaItems.length - 1);
    };
  ...
  return (
    <Container className="mb-[8.5px] w-full pr-0">
      ...
      <div className="relative">
        ...
        >
          ...
          {/* <CarouselPrevious
            className={cn(
              'absolute left-2 z-10 border-transparent bg-[#F07E58] text-white hover:bg-[#d26d4b] hover:text-white',
              currentIndex === 0 && 'bg-transparent'
            )}
          />
          <CarouselNext
            className={cn(
              'absolute right-2 z-10 border-transparent bg-[#F07E58] text-white hover:bg-[#d26d4b] hover:text-white',
              currentIndex === sequencedTriviaItems.length - 1 && 'bg-transparent'
            )}
          /> */}
        </Carousel>
        ...
        {/* <div
          className={cn(
            'pointer-events-none absolute left-0 top-0 h-full w-16 bg-gradient-to-r from-white to-transparent transition-opacity duration-1000 ease-in-out',
            showLeftGradient ? 'opacity-100' : 'opacity-0'
          )}
        />
        <div
          className={cn(
            'pointer-events-none absolute right-0 top-0 h-full w-16 bg-gradient-to-l from-white to-transparent transition-opacity duration-1000 ease-in-out',
