...
import YourBrandSampleModal from './components/YourBrandSampleModal';

const YourBrandSample: React.FC = () => {
  ...
  return (
    <div className="relative flex w-screen flex-col items-center py-4 font-['Gilroy'] transition-all duration-150 ease-in-out">
      ...
      {/* <EnjoyingRenewMe /> */}
      {isModalOpen && <YourBrandSampleModal listId={process.env.NEXT_PUBLIC_COMMON_CONSTANT_CONTACT_LIST_ID} onTermsOpen={closeYourBrandSampleModal} />}
...
export default YourBrandSample;
