...
const AwakeningBalance = () => {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        // Fetch the "Awakening Balance" album - you might need to adjust the slug
        const result = await fetchAlbum('awakening-balance');
