...
const BossOfYourLife = () => {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        // Fetch the "Boss of Your Life" album - you might need to adjust the slug
        const result = await fetchAlbum('boss-of-your-life');
