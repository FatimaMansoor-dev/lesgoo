import DrLisaPalmer from 'modules/DrLisaPalmer';
import { NextPage } from 'next';

import Head from 'next/head';

const DrLisaPalmerPage: NextPage = () => {
  return (
    <>
      <Head>
        <title>Dr. Lisa Palmer</title>
        ...
        {/* <!--  Open Graph / Facebook --> */}
        <meta property="og:title" content="Dr. Lisa Palmer" />
        <meta property="og:type" content="website" />
        <meta property="og:site_name" content="RenewMe QR" />
        <meta property="og:url" content="https://www.myrenewme.com/drlisapalmer" />
        <meta
          property="og:image"
...
export default DrLisaPalmerPage;
