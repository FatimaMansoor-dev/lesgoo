import KarmaTravelDemo from 'modules/KarmaTravelDemo';
import { NextPage } from 'next';

import Head from 'next/head';

const KarmaTravelPage: NextPage = () => {
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://www.myrenewme.com/karma-travel-demo" />
        <meta
          property="og:image"
...
export default KarmaTravelPage;
