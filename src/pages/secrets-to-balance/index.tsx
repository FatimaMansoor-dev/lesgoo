...
const AwakeningBalance = () => {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        // Fetch the "Secrets to Balance" album - you might need to adjust the slug
        const result = await fetchAlbum('secrets-to-balance');
          ...
          tracks: [
            {
              ...
              preview: null,
              duration: '1:58',
              album: { title: 'Secrets to Balance' },
            },
            {
              id: '2',
