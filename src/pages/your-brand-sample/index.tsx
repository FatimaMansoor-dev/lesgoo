import YourBrandSample from 'modules/YourBrandSample';
import { NextPage } from 'next';

import Head from 'next/head';

const YourBrandSamplePage: NextPage = () => {
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://www.myrenewme.com/your-brand-sample" />
        <meta
          property="og:image"
...
export default YourBrandSamplePage;
